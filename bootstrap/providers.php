...
return [
    ...
    App\Features\Accounting\Infrastructure\Providers\AccountingServiceProvider::class,
    App\Features\AccountingManagement\Infrastructure\Providers\AccountingManagementServiceProvider::class,
