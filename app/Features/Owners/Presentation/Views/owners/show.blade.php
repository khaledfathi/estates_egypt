                        ...
                        <form class="card-block" method="{{ route('owners.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" id="name"
                                    placeholder="اسم مالك العقار / الوحدة" value="{{ $owner->name }}" readonly>
                            </div>
                            {{-- / name --}}
                            ...
                            <div class="form-group">
                                ...
                                <input name="national_id" type="text" class="form-control" id="national_id"
                                    placeholder="14 رقم" value="{{ $owner->nationalId }}" readonly>
                            </div>
                            {{-- / national id --}}
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control " id="address" placeholder="وصف دقيق للعنوان" readonly>{{ $owner->address }}</textarea>
                            </div>
                            {{-- / address --}}
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" class="form-control readonly-bg" id="notes"
                                    placeholder="اى ملاحظات او تفاصيل اخرى عن المالك">{{ $owner->notes }}</textarea>
                            </div>
                            {{-- / notes --}}
                    </div>
                </div>
