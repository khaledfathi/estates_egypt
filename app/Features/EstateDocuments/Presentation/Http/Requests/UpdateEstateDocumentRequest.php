...
class  UpdateEstateDocumentRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'title' => 'required|max:150|unique:estate_documents,title,'
                . $this->route('document') . ',id,estate_id,' . $this->route('estate'),
            'file' => 'sometimes|required|max:10240|mimes:jpeg,png,jpg,webp,avif,pdf'
        ];
    }
