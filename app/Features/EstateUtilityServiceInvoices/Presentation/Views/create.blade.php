        ...
        @isset($estateUtilityService)
            ...
            <div class="row" style="display:flex; justify-content: center;">
                <form id="form" class="col-sm-12 col-md-10 col-lg-6" method="post"
                    action="{{ route('estates.utility-services.invoices.store', ['estate' => $estate->id, 'utility_service' => $estateUtilityService->id]) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            {{-- type --}}
                            <label for=" "> نوع المرفق : {{ $estateUtilityService->type->toLabel() }}</label><hr>
                            {{-- type --}}
                            ...
                            <div class="form-group">
                                ...
                                <input name="amount" type="text" class="form-control" id="amount"
                                    placeholder="المبلغ المطلوب سدادة للمرفق" value="{{ old('amount') }}">
                            </div>
                            {{-- / amount --}}
