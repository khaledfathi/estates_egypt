...
final class EditRentInvoicePresenter implements EditRentInvoiceOutput
{
   ...
   private function handleSession()
   {
      ...
      $this->previousURL = session($previousPage)
         ?? route('estates.units.contracts.rent-invoices' , ['' , '', '','']);
   }
    public function onSuccess(RentInvoiceEntity $rentInvoiceEntity): void
    {
        ...
        $this->response = fn() => view('rent-invoices::edit', $data);
    }
    public function onNotFound(): void
    {
        $this->response = fn() => view("rent-invoices::edit", [
            'found' => false,
