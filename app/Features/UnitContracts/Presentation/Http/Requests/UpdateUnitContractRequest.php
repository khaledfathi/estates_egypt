...
class UpdateUnitContractRequest extends FormRequest
{
    /**
    ...
    {
        return [
        'renter_id' => 'nullable|numeric|exists:renters,id',
        'contract_type' => [
            'required',
        ...
        'start_date' => [
            'required',
            'date',
            new UnitContractDateIntersectionRule($this->end_date, $this->route('unit') , $this->contract),
        ],
