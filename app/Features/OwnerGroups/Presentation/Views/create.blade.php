...
@section('content')
    <div class="container-fluid ">
        ...
        <div class="row" style="display:flex; justify-content: center;">
            <form id="form" class="col-sm-12 col-md-10 col-lg-6" method="post" action="{{ route('owner-groups.store') }}">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group" style="margin-top: 40px">
                            <button id="submit-btn" type="submit" class="btn btn-md btn-success">
                                ...
                                اضافة</button>
                            <a href="{{ route('owner-groups.index') }}" class="btn btn-md btn-danger"><i class="fa fa-ban"></i>
                                الغاء</a>
                        </div>
                        {{-- / buttons --}}
                    </div>
